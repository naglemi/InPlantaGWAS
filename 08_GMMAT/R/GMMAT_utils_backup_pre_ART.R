...
GMMAT_workflow <- function(phenotype_path, covariate_path, kinship_path, gds_path, ncores, outdir, alpha = 0.05, n_SNPs = 1000){
...
GMMAT_workflow.newbeta <- function(phenotype_path, covariate_path, kinship_path, gds_path, ncores, outdir,
                           alpha = 0.05, n_SNPs = 1000, pthresh = 1){
